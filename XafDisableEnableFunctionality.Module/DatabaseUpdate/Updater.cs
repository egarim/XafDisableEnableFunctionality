...
namespace XafDisableEnableFunctionality.Module.DatabaseUpdate {
    ...
    public class Updater : ModuleUpdater {
        ...
        public override void UpdateDatabaseAfterUpdateSchema() {
            ...
            if (ObjectSpace.GetObjectsCount(typeof(License), null) == 0)
            {
                License singleton = ObjectSpace.CreateObject<License>();
