...
namespace XafDisableEnableFunctionality.Blazor.Server {
    public partial class XafDisableEnableFunctionalityBlazorApplication : BlazorApplication {
        public XafDisableEnableFunctionalityBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XafDisableEnableFunctionalityBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
